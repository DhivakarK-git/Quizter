...
class _AddQuizState extends State<AddQuiz> {
  ...
  Future<void> getQuestions() async {
    final QueryResult quiz = await _quiz.queryA(gq.getFQuiz(quizId));
                        ...
                        child: Form(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              focusColor: kFrost,
                              hintText:
                                  "Please Enter a name for your Quiz here.",
                              hintStyle: Theme.of(context)
                                  .textTheme
                                  .headline5
                                  .copyWith(color: kMatte.withAlpha(189)),
                            ...
                            child: SingleChildScrollView(
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "Important Pointors regarding the Creation of a quiz",
                                      style:
...
• Faculty can correct the key of quiz if any unforeseen errors are found and alter the outcome of the quiz.
  ...
  Future<void> savetQuiz(String access) async {
    final QueryResult quiz = await _quiz
        .queryA(gq.saveTQuiz(quizname: quizname, accesscode: access));
    quizId = int.parse(quiz.data['createTquiz']['Quiz']['id']);
    final QueryResult auth = await _quiz.queryA(gq.getUser());
    userId = int.parse(auth.data['me']['usert']['id']);
    final QueryResult makes =
        await _quiz.queryA(gq.setMakes(quizId: quizId, userId: userId));
    accesscode = access;
  }
